...
output2 = word1[0:4]+"-" + word2[len(word2)-4:]# str: join first four letters of word1 and last four letters of word 2 with a hyphen "-" in between

output3 = word3+ " " + str(n1) # str: join the word3 and n1 with a space in between
h='-'
output4 = h*50 # str: just the hypen "-" repeated 50 times

output5 = h*n2 # str: just the hypen "-" repeated n2 times
...
ends_with_a = word1[len(word1)-1]=='a' # bool: True if word1 ends with letter a or A
